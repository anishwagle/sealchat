...
interface Profile {
  ...
  email: string;
  fullName?: string;
  friendCount?: number;  // Add these new properties
  profileLikes?: number;
}
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-6 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{profile.profileLikes || 0} Profile Likes</span>
                    </div>
                  </div>
                  <p className="mt-3 text-gray-600 max-w-2xl">
                    Passionate about building great software and contributing to open source projects.
                  </p>
                </div>
                <div>
                  <button className="flex items-center gap-2 px-6 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition-colors">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
